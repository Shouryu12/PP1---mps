...
class DocumentoInterface():
	...
	def cadastra_documento(self, documento):
		self.execute_query("insert into documento(documento_id, documento_tipo, documento_status)\
		 values ('{}', '{}', '{}')".format(documento.id, documento.tipo, documento.get_status()), True)
